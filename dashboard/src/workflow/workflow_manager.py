...
class SessionManager():
    def active_workflow(self):
        return self.workflows[len(self.workflows) - 1]
    ...
    def prefill_booking(self, booking):
        ...
        self.active_workflow().repository.el[self.active_workflow().repository.BOOKING_SELECTED_GRB] = self.make_grb_models(booking.resource.template)['bundle']
    ...
    def prefill_config(self, config):
        ...
        self.active_workflow().repository.el[self.active_workflow().repository.SWCONF_SELECTED_GRB] = config.bundle
