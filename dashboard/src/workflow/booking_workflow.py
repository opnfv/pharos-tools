...
class Resource_Select(WorkflowStep):
    ...
    def get_context(self):
        ...
        context['form'] = ResourceSelectorForm(chosen_resource=default, bundle=bundle, edit=edit)
        return context
    ...
    def get_context(self):
        ...
        if chosen_bundle:
            if chosen_bundle.id:
                ...
                default.append("repo bundle")
        bundle = self.repo_get(self.repo.GRESOURCE_BUNDLE_MODELS, {}).get("bundle")
        context['form'] = ResourceSelectorForm(chosen_resource=default, bundle=bundle)
        return context
...
class Booking_Meta(WorkflowStep):
    ...
    def get_context(self):
        ...
        """
            ...
            if "users" in forms["meta_form"].cleaned_data:
                context['added_list'] = forms["meta_form"].cleaned_data["users"]
            context['form'] = forms['meta_form']
        """
        return context
    ...
    def post_render(self, request):
        ...
        if form.is_valid():
            ...
            #models['booking'].length = form.cleaned_data['length']
