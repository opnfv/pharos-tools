...
class PDFTemplater:
    ...
    def get_pdf_host_node(cls, host):
        ...
        d['model'] = host.model
        d['arch'] = host.profile.cpuprofile.first().architecture
        d['cpus'] = host.profile.cpuprofile.first().cpus
        d['cores'] = host.profile.cpuprofile.first().cores
