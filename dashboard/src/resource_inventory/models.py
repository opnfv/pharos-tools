...
class Network(models.Model):
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=100)
    bundle = models.ForeignKey(GenericResourceBundle, on_delete=models.CASCADE)
...
class GenericInterface(models.Model):
    ...
    connections = models.ManyToManyField(NetworkConnection, on_delete=models.DO_NOTHING)
